xmlDeclaration()
    ...
    'rp:AnonymousRelyingParty'(provider: idpEntityId, defaultSigningCredentialRef: 'IdPCredential')
    newLine()
    newLine()
    'rp:DefaultRelyingParty'(provider: idpEntityId, defaultSigningCredentialRef: 'IdPCredential') {
    ...
    <security:Credential id="IdPCredential" xsi:type="security:X509Filesystem">
        <security:PrivateKey>$idpHome/credentials/idp.key</security:PrivateKey>
        <security:Certificate>$idpHome/credentials/idp.crt</security:Certificate>
    </security:Credential>
    ...
    <security:TrustEngine id="shibboleth.MetadataTrustEngine" xsi:type="security:StaticExplicitKeySignature">
        <security:Credential id="MyFederation1Credentials" xsi:type="security:X509Filesystem">
            <security:Certificate>$idpHome/credentials/federation1.crt</security:Certificate>
        </security:Credential>
